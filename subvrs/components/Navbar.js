...
export function SocialLinks() {
  ...
  return (
    <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
      ...
      {/* Resident Advisor */}
      <a href="https://ra.co/events/2481406" target="_blank" rel="noopener" aria-label="Resident Advisor" style={{ ...linkStyle, fontSize: '11px', fontWeight: 800, letterSpacing: '0.05em' }}
        onMouseEnter={e => e.currentTarget.style.color = 'var(--text)'}
        onMouseLeave={e => e.currentTarget.style.color = 'var(--text2)'}
      >RA</a>

      {/* Xceed */}
      <a href="https://xceed.me/en/torino/event/discopo-1/236715" target="_blank" rel="noopener" aria-label="Xceed" style={{ ...linkStyle, fontSize: '11px', fontWeight: 800, letterSpacing: '0.05em' }}
        onMouseEnter={e => e.currentTarget.style.color = 'var(--text)'}
        onMouseLeave={e => e.currentTarget.style.color = 'var(--text2)'}
      >XC</a>
    </div>
